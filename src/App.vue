...
<template>
  ...
  >
    <div class="bg-gray-50 rounded-xl p-6 shadow-lg">
      <input class="" type="file" name="" @change="handleFileChange" />
      <button
    ...
    <div
      class="bg-gray-50 w-[40rem] aspect-square shadow-lg rounded-xl mt-8 p-4 grid grid-cols-5 grid-rows-5 gap-4"
    >
      <div
        v-for="(item, index) in data"
        :key="index"
        class="bg-white shadow-lg rounded-xl overflow-hidden flex items-end"
      >
        <div
    ...
    <div
      class="bg-gray-50 w-[40rem] h-20 shadow-lg rounded-xl mt-8 overflow-hidden"
    >
      <div
